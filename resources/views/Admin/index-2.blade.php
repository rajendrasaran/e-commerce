            ...
            <div class="container ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    @foreach($slider as $_slider)
                    <img src="{{$_slider->getFirstMediaUrl('slider_image')}}">
                    @endforeach
                  </div>
                </div>
          ...
          <div class="carousel-item">
            <div class="container ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="{{$_slider->getFirstMediaUrl('slider_image')}}" alt="">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              ...
              <a href="{{route('detail',($_product->url_key??''))}}"><img src="{{$_product->getFirstMediaUrl('image')}}" alt=""></a>
              
              
              <form action="{{route('cart',$_product->id)}}" method="post">  
            ...
            <div class="detail-box">
              <h5>
                <a href="{{route('detail',($_product->url_key??''))}}">{{$_product->name}}</a>
              </h5>
              <div class="product_info">
                <h5>
                  <span>$</span>{{$_product->price}}
                </h5>
    ...
    <div class="container-fluid  ">
      <div class="row">
        ...
        <div class="col-md-6 px-0">
          <div class="img-box">
            <img src="{{asset('css/images/about-img.jpg')}}" alt="">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="box ">
            <div class="img-box">
              <img src="{{asset('css/images/w1.png')}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Fast Delivery
        ...
        <div class="col-md-4">
          <div class="box ">
            <div class="img-box">
              <img src="{{asset('css/images/w2.png')}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Free Shiping
        ...
        <div class="col-md-4">
          <div class="box ">
            <div class="img-box">
              <img src="{{asset('css/images/w3.png')}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Best Quality
            ...
            <div class="container">
              <div class="box">
                <div class="detail-box">
                  ...
                  @foreach($sliders as $_sliders)
                  <p>
                   {!!$_sliders->description!!}
                  </p>
                 @endforeach 
                </div>
                <div class="client-id">
                  <div class="img-box">
                    <img src="{{$_sliders->getFirstMediaUrl('slider_image')}}" alt="">
                  </div>
                  <div class="name">
                    <h5>
                      James Dew
          ...
          <div class="carousel-item">
            <div class="container">
              <div class="box">
                ...
                <div class="client-id">
                  <div class="img-box">
                    <img src="{{asset('css/images/client.jpg')}}" alt="">
                  </div>
                  <div class="name">
                    <h5>
                      James Dew
